...
class AppColors {
  ...
  static const Color lightDownloadButtonBackgroundColor = Color.fromARGB(255, 38, 38, 38);
  ...
  static const Color darkDownloadButtonForegroundColor = Color.fromARGB(255, 38, 38, 38);

  static const Color darkIsInstalledTextColor = Color.fromARGB(255, 86, 178, 248);
  ...
  static Color deleteIconColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkDeleteIconColor : lightDeleteIconColor;
  }

  static Color filesIconColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkFilesIconColor : lightFilesIconColor;
  }

  static Color downloadButtonBackgroundColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkDownloadButtonBackgroundColor : lightDownloadButtonBackgroundColor;
  }

  static Color downloadButtonForegroundColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkDownloadButtonForegroundColor : lightDownloadButtonForegroundColor;
  }

  static Color isInstalledTextColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkIsInstalledTextColor : lightIsInstalledTextColor;
  }
